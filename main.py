...
# dataset_url = "https://mybakerystorage.blob.core.windows.net/fishingcam/fishing_float.zip"
# data_dir = tf.keras.utils.get_file('fishing_float.zip', origin=dataset_url, extract=True)

data_dir = pathlib.Path(data_dir).with_suffix('')
# data_dir = "C:\Users\Hoang\Desktop\fishing_float"
